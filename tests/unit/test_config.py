...
def test_config_missing_anthropic_key_raises(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_config_default_empty_user_ids(monkeypatch: pytest.MonkeyPatch) -> None:
